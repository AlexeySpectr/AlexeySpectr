...
<h3>💻 Backend / Web</h3>
<p>
<img src="https://skillicons.dev/icons?i=html,css,js,php,laravel,wordpress" />
</p>

<h3>🐍 Python / Data Science / ML</h3>
<p>
...
- [Задачи с LeetCode на Python](https://github.com/AlexeySpectr/Python-tasks-from-leetcode) — решения задач и разбор декораторов.
- [Pandas и NumPy](https://github.com/AlexeySpectr/python-pandas-numpy) — анализ данных фильмов, базовые функции и команды библиотек.
- [Практика Kubernetes](https://github.com/AlexeySpectr/practis-k8s) — эксперименты с Kubernetes и DevOps-инфраструктурой.
...
# 🎯 Цель
Продолжаю развиваться в Data Science, Machine Learning, DevOps и backend-инженерии.  
Люблю создавать быстрые, надёжные и понятные системы.

---

<h3 align="center">🖤 Спасибо, что заглянул в мой GitHub!</h3>
